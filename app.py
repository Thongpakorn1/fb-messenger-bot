...
def analyze_image_with_gpt4(image_url):
   ...
   prompt_text = f"""
    ...
    จากภาพสินค้านี้ ช่วยวิเคราะห์ลักษณะเด่นของสินค้าจาก: 
    ทรง, สี, ลวดลาย, วัสดุที่ใช้
    โดยพิจารณาลักษณะเด่นจาก {product_descriptions}
    """  # เพิ่มคำอธิบายเพื่อให้การจับคู่ดีขึ้น
