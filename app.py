...
จากภาพด้านล่าง ช่วยวิเคราะห์ **ลักษณะเด่น, รูปทรง, ลวดลายหลัก, และสี** อย่างละเอียด จากนั้นเปรียบเทียบกับรายการสินค้าที่มีอยู่ในระบบ โดยพิจารณาจาก **ลักษณะเด่น (key_features)** ที่ระบุไว้ หากพบสินค้าที่ใกล้เคียงที่สุด ให้ตอบกลับพร้อมแจ้งชื่อสินค้า ขนาด น้ำหนัก และราคา:
