...
หากไม่พบสินค้าที่ตรงกันหรือใกล้เคียง **หลังจากพิจารณาทุกรายละเอียดในภาพและเปรียบเทียบกับข้อมูลแล้ว** ให้ตอบกลับด้วยข้อความ: "ไม่พบสินค้าที่ตรงกันในระบบค่ะ"

**สำคัญ:** ตอบกลับด้วยชื่อสินค้าเท่านั้น หรือ "ไม่พบสินค้าที่ตรงกัน"
"""
