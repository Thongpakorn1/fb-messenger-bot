...
เมื่อวิเคราะห์ภาพแล้ว ให้ระบุชื่อสินค้าที่ตรงกันมากที่สุด หากไม่พบสินค้าที่ตรงกันหรือใกล้เคียง ให้ตอบว่า "ไม่พบสินค้าที่ตรงกัน"
"""

**โปรดทราบว่าภาพที่ลูกค้าส่งมาอาจมีมุมหรือแสงที่แตกต่างจากภาพสินค้าจริงเล็กน้อย ให้พิจารณาลักษณะหลักและความคล้ายคลึงมากที่สุด** หากไม่พบสินค้าที่ตรงกันหรือใกล้เคียง **หลังจากพิจารณาทุกรายละเอียดในภาพและเปรียบเทียบกับข้อมูลแล้ว** ให้ตอบกลับด้วยข้อความ: "ไม่พบสินค้าที่ตรงกันในระบบค่ะ"
