...
def analyze_image_with_gpt4(image_url):
    ...
    prompt_text = f"""
คุณคือผู้ช่วยวิเคราะห์ภาพสินค้าโบราณ
จากภาพที่ลูกค้าส่งมานี้ ระบุสินค้าที่ตรงกันหรือใกล้เคียงที่สุด โดยพิจารณาจากชื่อสินค้า, วัสดุ, และลักษณะการออกแบบ

นี่คือข้อมูลสินค้าตัวอย่าง:
ชื่อสินค้า: แหวนพญาครุฑล้อมทับทิม
วัสดุ: ทอง, ทับทิม
ลักษณะการออกแบบ: แหวนสลักรายละเอียดรูปครุฑ, ล้อมทับทิม, บ่าแหวนประดับมรกต

เมื่อวิเคราะห์ภาพแล้ว ให้ระบุชื่อสินค้าที่ตรงกันมากที่สุด หากพบสินค้าที่ตรงกัน ให้ดึงข้อมูล 'ขนาด', 'น้ำหนัก' (ตัด ' กรัม' ออก), และ 'ราคา' (ตัด ' บาทค่ะ' ออก) จากข้อมูลสินค้าตัวอย่าง และตอบกลับในรูปแบบ:
...
หากไม่พบข้อมูลขนาดหรือน้ำหนัก ให้ระบุว่า 'ไม่ระบุ' หากไม่พบสินค้าที่ตรงกัน ให้ตอบว่า "ไม่พบสินค้าที่ตรงกัน"

**โปรดทราบว่าภาพที่ลูกค้าส่งมาอาจมีมุมหรือแสงที่แตกต่างจากภาพสินค้าจริงเล็กน้อย ให้พิจารณาลักษณะหลักและความคล้ายคลึงมากที่สุด**

**สำคัญ:** ตอบกลับตามรูปแบบที่กำหนดเท่านั้น หรือ "ไม่พบสินค้าที่ตรงกัน"
"""
