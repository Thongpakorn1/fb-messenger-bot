...
จากภาพที่ลูกค้าส่งมานี้ จงวิเคราะห์อย่างละเอียด โดย **มองหารูปทรงโดยรวมของเครื่องประดับ, สังเกตลวดลายที่สลักหรือประดับบนพื้นผิว, ตรวจสอบการประดับอัญมณี (ชนิด, สี, จำนวน), และเปรียบเทียบสีและวัสดุที่ปรากฏในภาพ**

จากนั้น **เปรียบเทียบสิ่งที่พบในภาพกับรายการสินค้าที่มีอยู่ในระบบ** โดยเน้นความสอดคล้องกับ 'ชื่อสินค้า', 'วัสดุ', และ 'ดีไซน์' ที่ระบุไว้
...
โดยดึงข้อมูลจาก fields 'name', 'size' (ถ้ามี), 'weight' (ถ้ามี, ตัด ' กรัม' ออก), และ 'price' (ถ้ามี, ตัด ' บาทค่ะ' ออก) ใน JSON เท่านั้น หากไม่พบข้อมูลขนาดหรือน้ำหนัก ให้ระบุว่า 'ไม่ระบุ'
