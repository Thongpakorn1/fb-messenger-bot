...
จากภาพที่ลูกค้าส่งมานี้ จงวิเคราะห์และเปรียบเทียบอย่างละเอียดกับรายการสินค้าที่มีอยู่ในระบบ โดยพิจารณาจากลักษณะต่างๆ ที่ปรากฏในภาพ เช่น ประเภท, วัสดุ, ดีไซน์, และรายละเอียดอื่นๆ

นี่คือรายการสินค้าที่มีอยู่ในระบบ พร้อมรายละเอียด (ชื่อสินค้า, วัสดุ, ดีไซน์):
{product_details}

เมื่อวิเคราะห์ภาพแล้ว ให้ระบุสินค้าที่ตรงกันหรือใกล้เคียงที่สุดเพียงรายการเดียว และตอบกลับด้วยรายละเอียดของสินค้านั้นในรูปแบบต่อไปนี้เท่านั้น:
...
หากไม่พบสินค้าที่ตรงกันหรือใกล้เคียงในภาพ ให้ตอบกลับด้วยข้อความ: "ไม่พบสินค้าที่ตรงกันในระบบค่ะ"
