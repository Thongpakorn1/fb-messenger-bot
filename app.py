...
def analyze_image_with_gpt4(image_url):
    ...
    prompt_text = f"""
คุณคือผู้ช่วยวิเคราะห์ภาพสินค้า
จากภาพที่ลูกค้าส่งมานี้ ระบุชื่อสินค้าที่ตรงกันหรือใกล้เคียงที่สุดจากรายการต่อไปนี้:

{', '.join([item['name'] for item in product_list])}
