...
จากภาพที่ลูกค้าส่งมานี้ ช่วยเปรียบเทียบกับรายการสินค้าที่มีในระบบ แล้วบอกว่าใกล้เคียงที่สุดคือสินค้ารายการไหน โดยให้ข้อมูลที่ชัดเจนตามนี้:

1. ชื่อสินค้า: (ชื่อสินค้า)
2. ขนาด: (ขนาดนิ้วหรือขนาดอื่นๆ)
3. น้ำหนัก: (น้ำหนักสินค้า)
4. ราคา: (ราคา)
